...
class AdrenoPerSeriesDefinition:
  ...
  def get_all_perfcounters_as_one_enum(self):
    ...
    """
    cases = []
    for group_id, (group_name, group) in enumerate(sorted(self.groups.items())):
  ...
  def get_perfcounter_enum_value_to_selector_conversion(self) -> str:
    ...
    logic = f"return perfcounter & ({ADRENO_MAX_COUNTER_COUNT_PER_GROUP}u - 1u);"
