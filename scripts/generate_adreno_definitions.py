...
class AdrenoPerSeriesDefinition:
  ...
  def get_all_perfcounters_as_one_c_header(self):
      ...
      for case in group.values():
        ...
        cases.append(
            ADRENO_C_ENUM_CASE_TEMPALTE.format(series=self.series,
                                               ...
                                               symbol=case.symbol,
                                               value=value))
    enum = ADRENO_C_ENUM_TEMPALTE.format(series=self.series.lower(),
                                         cases="\n  ".join(cases))
    return ADRENO_C_HEADER_TEMPLATE.format(series=self.series, content=enum)
...
def main(args):
  ...
  with open(a5xx_c_header, "w") as f:
    f.write(a5xx_definition.get_all_perfcounters_as_one_c_header())
  ...
  with open(a6xx_c_header, "w") as f:
    f.write(a6xx_definition.get_all_perfcounters_as_one_c_header())
