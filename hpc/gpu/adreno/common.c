...
static uint32_t adreno_common_perfcounter_convert_to_a6xx(
    hpc_gpu_adreno_common_perfcounter_t perfcounter);
static uint32_t adreno_common_perfcounter_convert_to_a5xx(
    hpc_gpu_adreno_common_perfcounter_t perfcounter);
...
static inline uint32_t adreno_common_perfcounter_get_group(
    hpc_gpu_adreno_common_perfcounter_t perfcounter) {
